...
Mobile.tapAndHold(findTestObject('Object Repository/TC5.0_delete_note/android.widget.TextView - Regression Testing'), 0, 
    0)

Mobile.tap(findTestObject('Object Repository/TC5.0_delete_note/android.widget.TextView - API Testing'), 0)
...
Mobile.verifyElementNotExist(findTestObject('TC5.0_delete_note/android.widget.TextView - Regression Testing'), 0)

Mobile.verifyElementNotExist(findTestObject('TC5.0_delete_note/android.widget.TextView - API Testing'), 0)
